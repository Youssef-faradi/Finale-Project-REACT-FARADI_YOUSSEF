...
const Footer = () => {
    return (
        <>
            <div className='h-[60vh] w-full bg-[--secondary] flex items-center '>
                <div className='w-[40%] px-[5%] h-[70%]'>
                    <h3>GET IN TOUCH</h3>
                ...
                <div className='w-[40%] flex  justify-between   text-sm h-[70%]'>
                    <div className='w-[30%]'>
                    ...
                    <div class="flex ">
                        <div class="relative">
                            <input
                                ...
                                name="username"
                                type="text"
                                class="border-b border-gray-300 py-1 focus:border-b-2 focus:border-[--third] transition-colors focus:outline-none peer bg-inherit"
                            />
                            <label
                                for="username"
                                class="absolute left-0 top-1 cursor-text peer-focus:text-xs peer-focus:-top-4 transition-all peer-focus:text-[--third] "
                            >Email</label>
                        </div>
                    </div>
                    <button class="w-[150px] bg-black h-[50px] my-3 flex items-center justify-center rounded-full cursor-pointer relative overflow-hidden transition-all duration-500 ease-in-out shadow-md hover:scale-105 hover:shadow-lg before:absolute before:top-0 before:-left-full before:w-full before:h-full before:bg-gradient-to-r before:from-[#4a3ac7] before:to-[rgb(105,184,141)] before:transition-all before:duration-500 before:ease-in-out before:z-[-1] before:rounded-xl hover:before:left-0 text-[#fff]">
                        Subscribe
                    </button>
                </div>
            </div>
